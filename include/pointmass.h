...
{
public:
    PointMass(double newMass = 0,
              const Vectors::Vector3D<double> &newPosition = Vectors::Vector3D<double>(0.),
              const Vectors::Vector3D<double> &newVelocity = Vectors::Vector3D<double>(0.));
    PointMass(const Vectors::Vector3D<double>& newPosition);
    ...
    void setPosition(const Vectors::Vector3D<double> &newPosition);
    void setVelocity(const Vectors::Vector3D<double> &newVelocity);
    void setMass(double newMass);
    void setNetForce(const Vectors::Vector3D<double> &newNetForce);
    void addForce(const Vectors::Vector3D<double> &extraForce);

    const Vectors::Vector3D<double>& getPosition() const;
    const Vectors::Vector3D<double>& getVelocity() const;
    const Vectors::Vector3D<double>& getNetForce() const;
    double getMass() const;

    Vectors::Vector3D<double> getTrajectory(double time) const;
...
private:
    Vectors::Vector3D<double> position;
    Vectors::Vector3D<double> velocity;
    Vectors::Vector3D<double> netForce;
    double mass;
};
